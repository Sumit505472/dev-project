      ...
      >
        ...
        {!fullscreen && showInput && (
          <textarea
            ...
            className="w-full p-2 border-t border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm font-mono resize-none overflow-auto"
            style={{ height: `${100 - editorHeightPercent}vh`, minHeight: "60px" }}
          />
        )}
